...
probe_ORP_10_min_val = 0 #640 #690 #if ORP under this val, pump chlorine for 10 min
probe_ORP_5_min_val = 530 #690 #710 #if ORP only under this val, pump chlorine for 5 min
probe_pH_t2_min_val = 7.1 #if pH over this val, pump acid for 10 min
probe_pH_t1_min_val = 7.05 #if pH over this val, pump acid for 5 min
